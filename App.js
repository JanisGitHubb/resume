(function() {
    ...
    function animate() {
        ...
        Object.keys(models).forEach(function(key) {
            ...
            m.group.position.lerp(m.targetPos, 0.04);
            ...
            m.group.traverse(function(child) {
                if (child.isMesh) {
                    ...
                    mats.forEach(function(mt) {
                        mt.transparent = true;
                        mt.opacity += (m.targetOpacity - mt.opacity) * 0.08;
            ...
            m.group.scale.lerp(new THREE.Vector3(sf, sf, sf), 0.05);
    ...
    function finishGoTo(section) {
        ...
        if (section === 'home') {
            ...
            setTimeout(function() { showHomeModel(currentHomeModel); }, 700);
            resetDetails();
        } else {
